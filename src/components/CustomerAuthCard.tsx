          ...
          <form onSubmit={handleSignIn} className="space-y-4">
            ...
            <div className="text-center pt-1">
              <button
                ...
                className="w-full py-2.5 bg-[#f5f3f3] hover:bg-[#eae7e6] text-[#1c1b1b] border border-[#e4e2e2] font-label-caps text-xs uppercase tracking-wider font-bold rounded-xs transition-colors cursor-pointer flex items-center justify-center gap-1.5"
              >
