...
export const WhatsAppButton: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute left-full ml-4 whitespace-nowrap bg-[#1c1b1b] text-white text-xs px-3 py-2 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none shadow-md font-label-caps tracking-widest">
        CHAT WITH US
      </span>
    </a>
  );
